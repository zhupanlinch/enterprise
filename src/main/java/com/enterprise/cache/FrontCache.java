...
public class FrontCache implements ServletContextAware {
	 ...
	 * @throws Exception
	 */
	public void loadServiceCard() throws Exception{
		List<ServiceCard> services = new ArrayList<ServiceCard>();
		services = serviceCardService.selectList(new ServiceCard());
		systemManage.setServiceCard(services);
	}
