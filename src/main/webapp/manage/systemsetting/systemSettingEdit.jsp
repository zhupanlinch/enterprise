                ...
                <div id="tabs-4">
                    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                        <tr>
                            <td style="text-align: left;" colspan="2">
                                <div class="alert alert-info">
                                    此功能为设置门户网站的界面展示风格，设置成功后可以前往<a style="color:red;" target="_blank" href="<%=path %>">首页,点击这里前往</a>查看效果。
                                    <br/>
                                    注意：如果需要特殊的界面展示效果，请联系开发者重新开发一套界面风格模板，放到服务端webapp目录下面
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right; width: 100px">风格设置</td>
                            <td style="text-align: left;">
                                <select name="style" value="${e.style}" id="style" data-rule="风格设置:required;style;length[0~100];">
                                  <option value ="front" <c:if test="${e.style=='front'}">selected</c:if>>默认</option>
                                  <option value ="modern" <c:if test="${e.style=='modern'}">selected</c:if>>摩登</option>
                                </select>
                            </td>
                        </tr>
                    </table>
